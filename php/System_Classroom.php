...
//강의실명 배열에 추가
$Classroom_All = array("101","102","101/102","103","104","103/104","201","202","201/202","203","204","203/204","205","206","205/206","207","208","207/208","세미나1","세미나2","세미나3","세미나4","메이커스페이스","어린이집","음악실","음악실1","음악실2","미술실","별동천 세미나실","강당","방송실","회의실");
...
<h4><strong>강의실 - <?php echo $_COOKIE[Season];?></strong></h4>
<table class="w3-card-4 w3-bordered w3-centered w3-small w3-hide-small">
  <thead>
<form action="index.php?id=System_Classroom" method="post">
  <select style="width:100%" name="plan_classroom" onchange="form.submit()"><option>아래에서 강의실을 선택하세요.</option>
    <?php
...
<table style="width:100%" class="w3-card-4 w3-bordered w3-centered w3-small">
  <thead>
    <tr>
      ...
      <th>
      <?php
      echo '<form action="print.php?id=System_Classroom" method="post" target="_blank">';
      echo '<input class="w3-input" name="plan_classroom" value="'.$_POST['plan_classroom'].'" type="hidden"><input class="w3-button w3-theme-l4 w3-hide-small" type="submit" name="submit" value="인쇄"></form>';
       ?></th>
    </tr>
  </thead>
  <tbody>
